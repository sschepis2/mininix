...
public final class RunScript extends RemoteInterface {
    private static final String ACTION_RUN_SCRIPT = "linuxdroid.mininix.RUN_SCRIPT";

    private static final String EXTRA_WINDOW_HANDLE = "linuxdroid.mininix.window_handle";
    private static final String EXTRA_INITIAL_COMMAND = "linuxdroid.mininix.iInitialCommand";
