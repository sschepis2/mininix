...
public final class RunShortcut extends RemoteInterface {
    public static final String ACTION_RUN_SHORTCUT = "linuxdroid.mininix.RUN_SHORTCUT";

    public static final String EXTRA_WINDOW_HANDLE = "linuxdroid.mininix.window_handle";
    public static final String EXTRA_SHORTCUT_COMMAND = "linuxdroid.mininix.iShortcutCommand";
