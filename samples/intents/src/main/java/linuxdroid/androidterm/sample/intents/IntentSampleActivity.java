package linuxdroid.mininix.sample.intents;
...
public class IntentSampleActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        addClickListener(R.id.openNewWindow, new OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent =
                        new Intent("linuxdroid.mininix.OPEN_NEW_WINDOW");
        ...
        addClickListener(R.id.runScript, new OnClickListener() {
            public void onClick(View v) {
                /* Intent for opening a new window and running the provided
                   ...
                   linuxdroid.mininix.permission.RUN_SCRIPT in your manifest
                   to use */
                Intent intent =
                        new Intent("linuxdroid.mininix.RUN_SCRIPT");
                intent.addCategory(Intent.CATEGORY_DEFAULT);
                String command = script.getText().toString();
                intent.putExtra("linuxdroid.mininix.iInitialCommand", command);
                startActivity(intent);
            }});
        addClickListener(R.id.runScriptSaveWindow, new OnClickListener() {
            public void onClick(View v) {
                ...
                if (mHandle != null) {
                    ...
                    intent.putExtra("linuxdroid.mininix.window_handle",
                            mHandle);
                }
    ...
    protected void onActivityResult(int request, int result, Intent data) {
        ...
        if (request == REQUEST_WINDOW_HANDLE && data != null) {
            mHandle = data.getStringExtra("linuxdroid.mininix.window_handle");
