...
package linuxdroid.mininix.sample.pathbroadcasts;
...
public class PathReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
         ...
         * linuxdroid.mininix.permission.APPEND_TO_PATH
         * to receive this broadcast.
         */
        if (action.equals("linuxdroid.mininix.broadcast.APPEND_TO_PATH")) {
        ...
        /**
         * You need to declare the permission
         * linuxdroid.mininix.permission.PREPEND_TO_PATH
         * to receive this broadcast.
         *
         ...
         */
        if (action.equals("linuxdroid.mininix.broadcast.PREPEND_TO_PATH")) {
